...
<main>
  <section>
    <div class="form_layout">
      <form method="post" action="{{ route('register') }}?path={{ $path }}&shop_id={{ $shop_id }}&shop_password={{ $shop_password }}&menu={{ $menu }}&reserve={{ $reserve }}&date={{ $date }}&time={{ $time }}&member={{ $member }}&kbn={{ $kbn }}">
        <table class="form_table">
          @csrf
          <tr>
            <td colspan="2" class="tag">新規ユーザー登録</td>
          </tr>
          ...
          <tr>
            ...
            <td class="form_item2 form_margin">
              <input type="text" name="name" placeholder="UserName" class="form_input">
            </td>
          </tr>
          <tr>
            <td></td>
