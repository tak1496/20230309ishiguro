        ...
        <table class="owner_reg_tbl">
          ...
          <tr>
            ...
            <td>
              ...
              @enderror
              @if($shop->photo != '')
              <p class="thumbnail_content">
                <input type="text" id="thumbnail_name" name="thumbnail_name" value="{{ $shop->photo }}" readonly /><br>
                <img id="thumbnail" src="{{ Storage::disk('s3')->url('public/img/shop_'. $shop->id .'/'. $shop->photo); }}" />
              </p>
              @endif
            </td>
          </tr>
